...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{route('dokter')}}">@yield('title')</a></div>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('dokter.update',$id->id)}}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            <label for="nama">Nama dokter <code>*)</code></label>
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            <label for="spesialisasi">Spesialisasi <code></code></label>

                            <select class="form-control  @error('spesialisasi') is-invalid @enderror" name="spesialisasi" required>
                                @if(old('spesialisasi'))
                                    <option>{{old('spesialisasi')}}</option>
                                @else
                                    @if($id->spesialisasi)
                                    <option>{{$id->spesialisasi}}</option>
                                    @endif
                                @endif

                                <option>Umum</option>
                                <option>Estetika</option>
                            </select>
                            @error('spesialisasi')<div class="invalid-feedback"> {{$message}}</div>
                            @enderror
                        </div>
