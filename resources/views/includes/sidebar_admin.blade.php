            ...
            <li class="nav-item dropdown {{$pages=='users' || $pages=='tapel' || $pages=='siswa' || $pages=='guru'|| $pages=='kelas' || $pages=='guru' || $pages=='mapel' ? 'active' : ''}}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li {{$pages=='tapel' ? 'class=active' : ''}}><a class="nav-link" href="{{route('tapel')}}"><i class="fas fa-passport"></i> <span>Produk</span></a></li>
                    <li {{$pages=='kelas' ? 'class=active' : ''}}><a class="nav-link" href="{{route('kelas')}}"><i class="fas fa-school"></i><span>Treatment</span></a></li>
                    <li {{$pages=='siswa' ? 'class=active' : ''}}><a class="nav-link" href="{{route('siswa')}}"><i class="fas fa-user-graduate"></i><span>Dokter</span></a></li>
                    <li {{$pages=='guru' ? 'class=active' : ''}}><a class="nav-link" href="{{route('guru')}}"><i class="fas fa-chalkboard-teacher"></i><span>Member</span></a></li>
            ...
            <li class="nav-item dropdown {{$pages=='mapel' || $pages=='silabus' || $pages=='penilaian' ? 'active' : ''}}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li {{$pages=='mapel' ? 'class=active' : ''}}><a class="nav-link" href="{{route('mapel')}}"><i class="fab fa-monero"></i> <span>Perawatan</span></a></li>
                    <li {{$pages=='silabus' ? 'class=active' : ''}}><a class="nav-link" href="{{route('silabus')}}"><i class="fas fa-microchip"></i> <span>Penjadwalan</span></a></li>
                </ul>
            </li>
            <li class="nav-item dropdown  {{$pages=='absensi' || $pages=='pelanggaran'  ? 'active' : ''}}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li {{$pages=='absensi' ? 'class=active' : ''}}><a class="nav-link" href="{{route('absensi')}}"><i class="fas fa-id-card-alt"></i><span>Rekap Pembayaran</span></a></li>
                    <li {{$pages=='pelanggaran' ? 'class=active' : ''}}><a class="nav-link" href="{{route('pelanggaran')}}"><i class="fas fa-times-circle"></i><span>Rekap Perawatan</span></a></li>
                </ul>
            </li>
